import 'package:baseapp/p_main_app/app_widgets_p/app_module_specific_widgets_p/masked_textInput_formatter.dart';
import 'package:baseapp/p_main_app/z_main_files_p/AppValuesFilesLink.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';

class TextPaymentCardInputFieldWithoutError extends StatelessWidget {
  ...
  final List<MaskedTextInputFormatter> cardInputFormat;

  TextPaymentCardInputFieldWithoutError({Key key,
  this. keyboardType,
  this.inputAction,
  this.maxLength,
  this.readOnly,
  ...
  this.textStyle,
  this.suffixIcon,
  this.ontextChanged,this. onSubmit,this.cardInputFormat});
